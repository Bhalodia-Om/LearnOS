#include "vga.h"
#include "keyboard.h"
#include "io.h"        // inb + keyboard ports, used by read_move_key

// kernel.cpp is now just the entry point + the Rock Paper Scissors game. Everything else (screen, keyboard, strings) has its own file.
...
extern "C" void kernel_main() {
    ...
    print("LeveretOS - Lesson 8: Restructure(There is no change in capabilities from lesson 7)\n\n"); 
